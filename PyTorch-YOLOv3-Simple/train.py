...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_config", type=str, default="config/shoulders.data", help="path to data config file")
    parser.add_argument("--pretrained_weights", type=str, default = "checkpoint/yolov3_ckpt_195.pth", help="if specified starts from checkpoint model")
